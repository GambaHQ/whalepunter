...
export async function GET(
  ...
  try {
    ...
    // Get handler with all their race entries
    ...
    const completedRaces = handler.entries.filter(
    ...
    return NextResponse.json(handlerProfile);
  } catch (error) {
